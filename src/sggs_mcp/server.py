...
SERVER_INSTRUCTIONS = (
    "Use smart_search as the default entry point for SGGS questions. "
    "Use find_line for exact or phonetic Gurbani quotes, get_ang for full Ang pages, "
    "get_shabad for full shabads, and semantic_search for broad concepts. "
    "Each query is independent; call tools fresh and verify verses before presenting "
    "interpretive claims as authoritative."
)
